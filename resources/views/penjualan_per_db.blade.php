...
@section('content')
        ...
        <div class="col-4 text-center bg-white p-3">
            <form method="post">
                ...
                <div class="mb-3 form-group">
                    <label for="db" class="form-label">Distributor</label>
                    <select id="elem_db" name="db" class="form-control">
    ...
    <script>
        ...
        const elem_db = document.getElementById('elem_db');

        // get db list
        fetch('/penjualan_per_db/get_db', {
            headers: {
